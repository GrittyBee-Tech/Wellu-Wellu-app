    ...
    <section className="health-tips mb-36 mt-11">
      ...
      <div className=" md:container  md:mx-auto px-20 md:flex mt-20">
        ...
        <div className="md:w-[733px] md:h-[602px] border-4 border-[#447B02] rounded-[24px] mt-10 pl-4">
          <h1 className="font-bold text-[#447B02] text-[24px]  font-Mulish leading-[120px] underline decoration[#447B02] md:ml-60">
            Importance of Herbs
          </h1>
          <div className="flex gap-3 md:w-[236] md:h-[49] ml-20 mr-20">
            <div className="mt-6">
              <svg
